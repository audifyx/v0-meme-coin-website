  ...
  return (
    <section id="about" className="bg-black text-white border-b-4 border-black relative overflow-hidden">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 rounded-full opacity-[0.03] bg-white blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-96 h-96 rounded-full opacity-[0.03] bg-white blur-3xl"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-20 relative z-10">
        ...
        <div className="group bg-gradient-to-br from-white to-gray-100 text-black p-12 border-4 border-white hover-lift-subtle animate-fade-in-up stagger-item-4 shadow-heavy smooth-transition overflow-hidden relative">
          <div className="absolute bottom-0 right-0 w-40 h-40 bg-black opacity-0 group-hover:opacity-5 rounded-full blur-3xl smooth-transition"></div>
