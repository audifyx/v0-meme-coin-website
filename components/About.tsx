    ...
    <section id="about" className="bg-black text-white border-b-4 border-black relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 py-20 relative z-10">
        <div className="mb-16">
          ...
          <div className="h-2 w-24 rounded-full bg-white animate-fade-in-up stagger-item-2"></div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-12">
          <div className="group bg-gradient-to-br from-white to-gray-100 text-black p-8 rounded-3xl border-4 border-white hover-lift-subtle animate-fade-in-up shadow-heavy smooth-transition overflow-hidden relative">
            ...
            <div className="h-1 w-12 rounded-full bg-black mb-6 group-hover:w-16 smooth-transition origin-left"></div>
          ...
          <div className="group bg-gradient-to-br from-white to-gray-100 text-black p-8 rounded-3xl border-4 border-white hover-lift-subtle animate-fade-in-up stagger-item-2 shadow-heavy smooth-transition overflow-hidden relative">
            <div className="absolute top-0 right-0 w-32 h-32 bg-black opacity-0 group-hover:opacity-5 rounded-full blur-2xl smooth-transition"></div>
        ...
        <div className="group bg-gradient-to-br from-white to-gray-100 text-black p-8 rounded-3xl border-4 border-white mb-8 hover-lift-subtle animate-fade-in-up stagger-item-3 shadow-heavy smooth-transition overflow-hidden relative">
          <div className="absolute top-0 left-1/2 w-32 h-32 bg-black opacity-0 group-hover:opacity-10 rounded-full blur-2xl smooth-transition -translate-x-1/2"></div>
          <h3 className="text-3xl font-black mb-8 group-hover:text-gray-800 smooth-transition">LAUNCH HISTORY</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group/item bg-white rounded-2xl p-8 hover-lift smooth-transition relative overflow-hidden animate-fade-in-up border-4 border-black">
              ...
              <p className="text-5xl font-black text-black mb-2">$5K</p>
              <p className="font-black text-lg mb-1 text-gray-800">Launch Price</p>
              <p className="text-sm font-bold text-gray-600">Day 1 start</p>
            </div>
            <div className="group/item bg-white rounded-2xl p-8 hover-lift smooth-transition relative overflow-hidden animate-fade-in-up stagger-item-2 border-4 border-black">
              <div className="absolute top-0 left-0 w-full h-1 bg-black scale-x-0 group-hover/item:scale-x-100 smooth-transition origin-left"></div>
              <p className="text-5xl font-black text-black mb-2">$1M</p>
              <p className="font-black text-lg mb-1 text-gray-800">Peak Achieved</p>
              <p className="text-sm font-bold text-gray-600">5 min to bond, 10 min to $200K</p>
            </div>
            <div className="group/item bg-white rounded-2xl p-8 hover-lift smooth-transition relative overflow-hidden animate-fade-in-up stagger-item-3 border-4 border-black">
              <div className="absolute top-0 left-0 w-full h-1 bg-black scale-x-0 group-hover/item:scale-x-100 smooth-transition origin-left"></div>
              <p className="text-5xl font-black text-black mb-2">$200K+</p>
              <p className="font-black text-lg mb-1 text-gray-800">Strong Floor</p>
              <p className="text-sm font-bold text-gray-600">Community holding strong</p>
            </div>
          </div>
        </div>

        <div className="group bg-gradient-to-br from-white to-gray-100 text-black p-8 rounded-3xl border-4 border-white hover-lift-subtle animate-fade-in-up stagger-item-4 shadow-heavy smooth-transition overflow-hidden relative">
          ...
          <div className="space-y-6 font-bold text-lg leading-relaxed">
            ...
            <div className="bg-black text-white p-8 rounded-2xl border-4 border-black my-6 relative overflow-hidden group/inner">
