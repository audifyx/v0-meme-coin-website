...
import { Wallet, Zap, FileText, ShoppingCart } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((step) => {
            ...
            return (
              <div
                key={step.number}
                className="relative bg-white border-4 border-black p-8 hover:shadow-lg transition-shadow duration-300 group"
              >
        ...
        <div className="mt-12 text-center">
          <a
            ...
            className="bg-black text-white px-12 py-4 font-black text-lg border-4 border-black inline-block hover:bg-gray-900 transition-colors duration-300"
          >
            START BUYING NOW
          </a>
        </div>
