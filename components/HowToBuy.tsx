    ...
    <section className="bg-white border-b-4 border-black relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 py-20 relative z-10">
        <div className="text-center mb-16">
          ...
          <div className="h-2 w-24 rounded-full bg-black mx-auto mb-8 animate-fade-in-up stagger-item-2"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {steps.map((step, idx) => {
            ...
            return (
              ...
              >
                <div className="relative bg-white rounded-3xl p-8 h-full border-4 border-black shadow-light hover:shadow-heavy smooth-transition overflow-hidden">
                  ...
                  <div className="relative mb-6 mt-8">
                    <div className="inline-block p-4 bg-black text-white group-hover:bg-gray-900 smooth-transition rounded-2xl">
                  ...
                  {/* Bottom accent line */}
                  <div className="absolute bottom-0 left-0 h-1 bg-black w-0 group-hover:w-full smooth-transition origin-left rounded-full"></div>
        ...
        <div className="text-center pt-8 animate-fade-in-up" style={{ animationDelay: '400ms' }}>
          <a
            ...
            className="group relative bg-black text-white px-16 py-6 font-black text-lg rounded-2xl border-4 border-black inline-block shadow-heavy hover-lift-subtle overflow-hidden"
          >
