          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-6 pt-6 animate-fade-in-up stagger-item-5">
                <button className="group bg-black text-white px-10 py-5 font-black text-lg border-4 border-black hover:bg-gray-900 smooth-transition hover-lift shadow-heavy relative overflow-hidden">
                ...
                <button
                  ...
                  className="group bg-white text-black px-10 py-5 font-black text-lg border-4 border-black hover:bg-black hover:text-white smooth-transition hover-lift shadow-light"
                >
                  LEARN MORE
                </button>
              </div>
