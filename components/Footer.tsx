        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="animate-fade-in-up stagger-item-3">
            ...
            <a
              ...
              className="group/btn inline-flex items-center gap-3 bg-black text-white px-8 py-4 font-black border-4 border-black hover:border-black smooth-transition hover-lift-subtle shadow-light relative overflow-hidden"
            >
